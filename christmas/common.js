...
const tableselectorid = document.getElementById("tableselector")
tableselectorid.addEventListener("change", function (e) {
    const target = e.target
    const htmlsectionid = document.getElementById("htmlsection")
    const jssectionid = document.getElementById("jssection")

    if(target.checked){
        if(target.value == "htmlsection"){
            htmlsectionid.classList.remove("hide")
            jssectionid.classList.add("hide")
        }else{
            htmlsectionid.classList.add("hide")
            jssectionid.classList.remove("hide")
        }
